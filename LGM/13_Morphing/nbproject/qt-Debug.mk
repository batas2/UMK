#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/13_Morphing
# Generated by qmake (2.01a) (Qt 4.6.2) on: niedz. maj 23 11:35:00 2010
...
QMAKE_TARGET  = 13_Morphing
DESTDIR       = dist/Debug/GNU-Linux-x86/
TARGET        = dist/Debug/GNU-Linux-x86/13_Morphing
...
dist: 
	@$(CHK_DIR_EXISTS) nbproject/build/Debug/GNU-Linux-x86/13_Morphing1.0.0 || $(MKDIR) nbproject/build/Debug/GNU-Linux-x86/13_Morphing1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/13_Morphing1.0.0/ && $(COPY_FILE) --parents MyWidget.h nbproject/build/Debug/GNU-Linux-x86/13_Morphing1.0.0/ && $(COPY_FILE) --parents MyWidget.cpp main.cpp nbproject/build/Debug/GNU-Linux-x86/13_Morphing1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/13_Morphing1.0.0` && $(TAR) 13_Morphing1.0.0.tar 13_Morphing1.0.0 && $(COMPRESS) 13_Morphing1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/13_Morphing1.0.0`/13_Morphing1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/13_Morphing1.0.0

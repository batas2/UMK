#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/05_b-sklejane
# Generated by qmake (2.01a) (Qt 4.6.2) on: niedz. mar 21 12:02:28 2010
...
QMAKE_TARGET  = 05_b-sklejane
DESTDIR       = dist/Debug/GNU-Linux-x86/
TARGET        = dist/Debug/GNU-Linux-x86/05_b-sklejane
...
dist: 
	@$(CHK_DIR_EXISTS) nbproject/build/Debug/GNU-Linux-x86/05_b-sklejane1.0.0 || $(MKDIR) nbproject/build/Debug/GNU-Linux-x86/05_b-sklejane1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/05_b-sklejane1.0.0/ && $(COPY_FILE) --parents main.cpp nbproject/build/Debug/GNU-Linux-x86/05_b-sklejane1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/05_b-sklejane1.0.0` && $(TAR) 05_b-sklejane1.0.0.tar 05_b-sklejane1.0.0 && $(COMPRESS) 05_b-sklejane1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/05_b-sklejane1.0.0`/05_b-sklejane1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/05_b-sklejane1.0.0

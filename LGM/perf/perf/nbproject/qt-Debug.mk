#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/perf
# Generated by qmake (2.01a) (Qt 4.6.2) on: czw. kwi 29 18:34:16 2010
...
OBJECTS       = build/Debug/GNU-Linux-x86/MyWidget.o \
		build/Debug/GNU-Linux-x86/MyThread.o \
...
TARGET        = dist/Debug/GNU-Linux-x86/perf
...
dist: 
	@$(CHK_DIR_EXISTS) nbproject/build/Debug/GNU-Linux-x86/perf1.0.0 || $(MKDIR) nbproject/build/Debug/GNU-Linux-x86/perf1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/perf1.0.0/ && $(COPY_FILE) --parents MyThread.h main.h FrameCounter.h MyWidget.h nbproject/build/Debug/GNU-Linux-x86/perf1.0.0/ && $(COPY_FILE) --parents MyWidget.cpp MyThread.cpp FrameCounter.cpp main.cpp nbproject/build/Debug/GNU-Linux-x86/perf1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/perf1.0.0` && $(TAR) perf1.0.0.tar perf1.0.0 && $(COMPRESS) perf1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/perf1.0.0`/perf1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/perf1.0.0

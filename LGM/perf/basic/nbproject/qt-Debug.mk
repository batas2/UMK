#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/basic
# Generated by qmake (2.01a) (Qt 4.6.2) on: czw. kwi 29 18:20:55 2010
...
SOURCES       = MyThread.cpp \
		...
		FrameCounter.cpp \
		main.cpp 
OBJECTS       = build/Debug/GNU-Linux-x86/MyThread.o \
		build/Debug/GNU-Linux-x86/MyWidget.o \
		build/Debug/GNU-Linux-x86/FrameCounter.o \
...
TARGET        = dist/Debug/GNU-Linux-x86/basic
...
dist: 
	@$(CHK_DIR_EXISTS) nbproject/build/Debug/GNU-Linux-x86/basic1.0.0 || $(MKDIR) nbproject/build/Debug/GNU-Linux-x86/basic1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/basic1.0.0/ && $(COPY_FILE) --parents MyThread.h main.h FrameCounter.h MyWidget.h nbproject/build/Debug/GNU-Linux-x86/basic1.0.0/ && $(COPY_FILE) --parents MyThread.cpp MyWidget.cpp FrameCounter.cpp main.cpp nbproject/build/Debug/GNU-Linux-x86/basic1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/basic1.0.0` && $(TAR) basic1.0.0.tar basic1.0.0 && $(COMPRESS) basic1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/basic1.0.0`/basic1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/basic1.0.0
...
build/Debug/GNU-Linux-x86/MyThread.o: MyThread.cpp MyThread.h \
		main.h \
		FrameCounter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/MyThread.o MyThread.cpp
...
build/Debug/GNU-Linux-x86/FrameCounter.o: FrameCounter.cpp FrameCounter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/FrameCounter.o FrameCounter.cpp

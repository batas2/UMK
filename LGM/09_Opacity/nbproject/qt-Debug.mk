#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/09_Opacity
# Generated by qmake (2.01a) (Qt 4.6.2) on: czw. kwi 1 19:36:11 2010
...
QMAKE_TARGET  = 09_Opacity
DESTDIR       = dist/Debug/GNU-Linux-x86/
TARGET        = dist/Debug/GNU-Linux-x86/09_Opacity
...
dist: 
	@$(CHK_DIR_EXISTS) nbproject/build/Debug/GNU-Linux-x86/09_Opacity1.0.0 || $(MKDIR) nbproject/build/Debug/GNU-Linux-x86/09_Opacity1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/09_Opacity1.0.0/ && $(COPY_FILE) --parents MyWidget.h nbproject/build/Debug/GNU-Linux-x86/09_Opacity1.0.0/ && $(COPY_FILE) --parents MyWidget.cpp main.cpp nbproject/build/Debug/GNU-Linux-x86/09_Opacity1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/09_Opacity1.0.0` && $(TAR) 09_Opacity1.0.0.tar 09_Opacity1.0.0 && $(COMPRESS) 09_Opacity1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/09_Opacity1.0.0`/09_Opacity1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/09_Opacity1.0.0
